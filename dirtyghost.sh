...
while true
do
	dialog --clear --nocancel --backtitle "\Zb\Z0Coded by Mulvun.. v3.0" \
	--colors --title "\Zb\Z0[\Zb\Z1 D I R T Y G H O S T \Zb\Z0- \Zb\Z1P O S T  E X P L O I T \Zb\Z0- \Zb\Z1T O O L \Zb\Z0]" \
